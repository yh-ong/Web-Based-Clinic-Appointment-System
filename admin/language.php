                ...
                <div class="card shadow-sm rounded">
                    <div class="card-body">
                        <form name="add_form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                            <div class="d-flex">
                                <input type="text" name="add_speciality" class="form-control mr-2" value="" placeholder="Add Language">
                    ...
                    <div class="card-body">
                        ...
                        <div class="data-tables">
                            <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    <?php
                                    $table_result = mysqli_query($conn, "SELECT * FROM language");
                                    while ($table_row = mysqli_fetch_assoc($table_result)) {
                                        ?>
                                        <tr>
                                            <td><?php echo $table_row["language_id"]; ?></td>
                                            <td><?php echo $table_row["language_name"]; ?></td>
                                            <td>
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="edit-modal<?php echo $table_row["language_id"]; ?>" tabindex="-1" role="dialog" aria-labelledby="ModalCenterTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="ModalCenterTitle">Edit Language</h5>
                                                    ...
                                                    <form name="update_form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                                        <div class="modal-body">
                                                            <small class="form-text text-muted">ID #<?php echo $table_row["language_id"]; ?></small>
                                                            <input type="hidden" name="speciality_id" value="<?php echo $table_row["language_id"]; ?>">
                                                            <input type="text" name="update_speciality" class="form-control" value="<?php echo $table_row["language_name"]; ?>">
                                                            <small class="form-text text-muted">Previous Name: <?php echo $table_row["language_name"]; ?></small>
                                                        </div>
