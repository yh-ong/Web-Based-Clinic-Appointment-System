...
if (isset($_POST['resetbtn'])) {
	...
	if (!$row = $result->fetch_assoc()) {
		echo "Need to resubmit the reset Request";
		exit();
	} else {
		...
		if ($tokenCheck === false) {
			echo "Resubmit Yur reset request";
		...
		<div class="login-wrap mx-auto">
			...
			<div class="login-body">
				...
				<div class="form-group">
						<p>You have requested to reset the password for <strong><?=$row['doctor_email']?></strong></p>
					</div>
					<?= display_error(); ?>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="inputPassword">6 Digit Code</label>
