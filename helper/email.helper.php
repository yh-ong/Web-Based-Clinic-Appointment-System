...
$mail = array(
    ...
    "con_content"=> "Hi, (Appointment Name), <br> Appointment confirmed with (Doctor Name) on (Wednesday, December 27, 2019) at (5:30PM). Please find the details below:",
    "con_button" => NULL,

    "acc_subject" => "New Clinic Me Account",
    "acc_title" => "Veify the Account",
    "acc_content" => "Hi, (Appointment Name), <br> Appointment confirmed with (Doctor Name) on (Wednesday, December 27, 2019) at (5:30PM). Please find the details below:",
    "acc_button" => "Click Here to Verify the Account",
                    ...
                    <tr>
                        <td bgcolor="#716df9" style="padding: 40px 30px 40px 30px;">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td align="center" style="padding: 10px 0 30px 0; color: #ffffff; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                        <strong>'.$token.'</strong>
                                    </td>
                                </tr>
                                '.$button_area.'
